...
export default function EditQuestionForm(props) {
    ...
    const [questionsOptions,setQuestionsOptions] = useState(props.question.questionsOptions);

    const [difficulty,setDifficulty] = useState(props.question.difficulty);

    const [lesson,setLesson] = useState(props.question.lesson);
            ...
            <div className="">
              ...
              <div className="mt-2 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div className="sm:col-span-6">
                  ...
                  <QuestionOptionsTable questionsOptions={questionsOptions}/>
